...
After the connection has been established left application panel contains a navigation tree with database structure
...
* Press Ctrl to add a new selection to existing one
