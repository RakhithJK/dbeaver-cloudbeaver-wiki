You can use teams to manage connection permissions in CloudBeaver. As a team is added to a user, the team connections become available for the user on the main page. 
