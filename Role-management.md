You can use roles to manage access permissions to connections in CloudBeaver. As a role is granted to a user, the role connections become available for the user on the main page. 
